...
function DetailTugas() {
  ...
  useEffect(() => {
    TugasService.getTugasById(uid).then((res) => { 
    ...
    <>
      ...
      <div className='flex flex-wrap py-3 mb-8'>
        ...
        {dataSoal.map((el, index) => (
          <div key={index} className='w-full md:w-1/4 md:mr-4 mb-4 text-left bg-custom-orange shadow-md rounded-lg dark:bg-gray-800'>
